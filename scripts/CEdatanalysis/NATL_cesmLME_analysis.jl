...
using JLD2, PythonPlot, Dates, Statistics, DrWatson, NCDatasets, OPTinv, RollingFunctions, DateFormats, Measurements, LinearAlgebra

jld = jldopen(OPTinv.datadir("NATL_cesmLME.jld2"))
mat = jld["mat"]
exp = jld["exp"]
inds = jld["inds"]
